...
from core.rag.graph.entities import GraphExtractionConfig, GraphRagConfigInput, GraphRetrievalConfig
...
class KnowledgeConfig(BaseModel):
    ...
    graph_retrieval_config: GraphRetrievalConfig | None = Field(
        default=None, description="Dataset graph retrieval configuration for first-document creation."
    )
    graph_extraction_config: GraphExtractionConfig | None = Field(
        default=None, description="Dataset graph extraction configuration for first-document creation."
    )
